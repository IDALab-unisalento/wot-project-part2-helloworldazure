...
#Questa funzione si attiva quando si riceve un messaggio e si pu lavorare su di esso
...
#sottoscrizione del Sub
if args.mode == 'both' or args.mode == 'subscribe':
    topic2="hello/world/erroreRitorno"
    myAWSIoTMQTTClient.subscribe(topic2, 0, None)
time.sleep(2)
...
while True:
	...
	tempura=int(temperature)
        message = {}
        message['state'] = "on"
        message['temp'] = tempura
     
        messageJson = json.dumps(message)
        #Creazione ed invio del messaggio
